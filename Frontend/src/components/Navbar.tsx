/**
 * Navbar - Monochrome top navigation bar matching login page aesthetic.
 */
      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-[11px] text-white/40 font-medium leading-none mt-0.5">Service Management Portal</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 px-3 py-1.5 bg-white/5 rounded-lg border border-white/10">
            <div className="w-7 h-7 rounded-full bg-white/15 flex items-center justify-center text-white text-xs font-bold">
